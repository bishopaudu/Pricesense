    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: const <BottomNavigationBarItem>[
            BottomNavigationBarItem(
              icon: FaIcon(FontAwesomeIcons.home,size:Sizes.bottomIconSize,),
              label: 'Home',
            ),
             BottomNavigationBarItem(
              icon: FaIcon(FontAwesomeIcons.file,size:Sizes.bottomIconSize),
              label: 'Survey',
            ),
            BottomNavigationBarItem(
              icon: FaIcon(FontAwesomeIcons.history,size:Sizes.bottomIconSize),
              label: 'History',
            ),
            
            BottomNavigationBarItem(
              icon: FaIcon(FontAwesomeIcons.user,size:Sizes.bottomIconSize),
              label: 'Agent',
            ),
