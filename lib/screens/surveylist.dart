      ...
      children: [
        ExpansionTile(
          ...
          children: macroeconomics.map((macro) {
            return ListTile(
              title: Text('Official USD Exchange Rate: ${macro.officialUsdExchangeRate}'),
              subtitle: Text('Monetary Policy Rate: ${macro.monetaryPolicyRate}'),
            );
          }).toList(),
        ),
        ExpansionTile(
      ...
      children: energyData.map((energy) {
        return ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              Text('Unofficial USD Exchange Rate: ${energy.unofficialUsdExchangeRate}'),
